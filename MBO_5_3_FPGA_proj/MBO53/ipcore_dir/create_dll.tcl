...
set result [ run_cg_create "xilinx.com:ip:dcmbd_sp:13.1" "dll" "Board Deskew with an Internal Deskew (DCM_SP)" "Board Deskew with an Internal Deskew (DCM_SP) (xilinx.com:ip:dcmbd_sp:13.1) generated by Project Navigator" xc3s500e-5fg320 Verilog ]
